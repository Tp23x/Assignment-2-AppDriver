                ...
                (tx, results) => {
                  ...
                  if(results.rowsAffected>0){
                    Alert.alert( 'Success', 'ยืนยันการเข้าสู่ระบบ',
                      [
                        {text: 'Ok', onPress: () => that.props.navigation.navigate('List')},
                      ],
                      { cancelable: false }
                    );
                  }else{
    ...
    render() {
      return (
        <View style={{ backgroundColor: 'white', flex: 1 }}>
          <Image resizeMode='center' style={{width:200, height: 240,marginLeft:80,marginTop:30,flex:1 }} source={require('./img/67965303_483689192365680_4909989690616053760_n.png')} />
